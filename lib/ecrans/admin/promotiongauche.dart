...
class PromotionGauchePage extends StatefulWidget {
  const PromotionGauchePage({super.key});

  @override
  State<PromotionGauchePage> createState() => _PromotionGauchePageState();
}

class _PromotionGauchePageState extends State<PromotionGauchePage> {
  ...
  Future<void> _loadPromotions() async {
    ...
    try {
      final promotions = await _promotionService.getAllPromotions('gauche');
      setState(() {
  ...
  void _startRealTimeSubscription() {
    _promotionService.startRealTimeSubscriptionGauche((promotions) {
      if (mounted) {
        setState(() {
          _promotions = promotions;
          _isLoading = false;
  ...
  Future<void> _deletePromotion(Promotion promotion) async {
    try {
      ...
      await supabase.storage.from('imagepromotion1').remove([fileName]);
              ...
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      'Gérez les images et vidéos affichées dans la colonne de gauche',
              ...
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.info_outline, color: Styles.bleu),
                        SizedBox(width: 8),
                        Text(
                          'Informations',
                          style: TextStyle(
